# Generated by Django 4.1.3 on 2023-01-05 16:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0014_remove_user_data_nascimento_remove_user_endereco'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(choices=[('G', 'Gerente'), ('F', 'Funcionario'), ('P', 'Professor')], max_length=1)),
                ('cpf_usuario', models.CharField(max_length=11, unique=True)),
                ('endereco_usuario', models.CharField(max_length=200)),
                ('email_usuario', models.CharField(max_length=256, unique=True)),
